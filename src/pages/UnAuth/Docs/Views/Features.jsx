    ...
    <div className="w-10/12 flex flex-col gap-4 items-start border border-gray-200 rounded-md p-2">
      ...
      <div className="flex flex-col gap-4 items-start w-full text-left">
        ...
        <p className="text-xs text-stone-800">
          The features we offer are important to the businesses we support.
          Browse through all the features we currently offer. Click on a feature
          to read more.
        </p>
      </div>
      ...
      <div className="w-full flex flex-col gap-4 items-start">
        ...
        >
          ...
          >
            <p className="text-xs text-left text-stone-800 mt-4">
              Secure payment links are sent via email to provide your customers
              with a safe and easy place to make a payment. Multiple payment
              methods are availble including cards, Google Pay and Apple Pay.
            </p>
          </div>
        </button>
        <button
        ...
        >
          <div className="w-full flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Layout size={18} />
              <p className="text-xs text-stone-800">Public Profile</p>
            </div>
            {view === 'pro' ? (
              <ChevronDown size={14} />
            ) : (
          ...
          <div
            className={`transition-[max-height] duration-300 ease-in-out overflow-hidden ${
              view === 'pro' ? 'max-h-40' : 'max-h-0'
            }`}
          >
            <p className="text-xs text-left text-stone-800 mt-4">
              Hosted public profile to showcase your business details, any
              successful payments, any reviews left by customers, and more. This
              can be shared anywhere you interact with potential customers.
            </p>
            <p className="text-xs text-left text-stone-700 mt-2 font-semibold">
              bizvo.io/bizName
            </p>
          </div>
        </button>

    ...
    <div className="w-10/12 flex flex-col gap-4 items-start border border-gray-200 rounded-md p-2">
      ...
      <div className="flex flex-col gap-4 items-start w-full text-left">
        ...
        <div className="flex items-center gap-2">
          <div className="p-1 border border-gray-200 rounded-md flex items-start justify-center gap-1">
        ...
        <p className="text-xs text-stone-800">
          ...
          at least one customer added will be required when creating. What is
          needed:
        </p>
        <div className="flex items-center gap-2">
